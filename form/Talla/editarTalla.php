...
if (isset($_GET['id'])) {
    ...
    $sql = $con->prepare("SELECT id,nombre,descripcion,unidad FROM talla WHERE id = $id");
    $sql->execute();
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarHeader">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a href="../../form/Color/formColor.php" class="nav-link">Disponibilidad</a>
                        </li>
                        <li class="nav-item">
                            <a href="../../form/Talla/gestionDia.php" class="nav-link">Dias Accesibles</a>
                        </li>
                        <li class="nav-item">
    ...
    <main>
        <div class="container">
            <form id="editarTallaForm" onsubmit="event.preventDefault(); editarTalla();">
                <div class="card m-5" style="width: 30rem;">
                    <div class="card-header">
                        Editar Dia Accesible
                    </div>
                    <div class="p-3">
                        <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre del dia accesible</label>
                            <input type="text" class="form-control" id="nombre" name="nombre"
                                value="<?php echo $talla['nombre']; ?>" required aria-describedby="nombreHelp" required
                                placeholder="Ingrese el nombre del dia accesible">
                            <input type="hidden" id="idTalla" name="idTalla" value="<?php echo $talla['id']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="nombre" class="form-label">Descripcion</label>
                            <input type="text" class="form-control" id="descripcion" name="descripcion"
                                value="<?php echo $talla['descripcion']; ?>" required aria-describedby="nombreHelp"
                                required placeholder="Ingrese el descripcion del dia accesible">
                        </div>
                        <div class="mb-3">
                            <label for="unidad" class="form-label">Unidad</label>
                            <input type="number" class="form-control" id="unidad" name="unidad"
                                value="<?php echo $talla['unidad']; ?>" required aria-describedby="nombreHelp" required
                                placeholder="Ingrese la cantidad de dias accesibles">
                        </div>

...
<body>
    ...
    <main>
        <div class="container">
            <form id="categoriaForm" onsubmit="event.preventDefault(); agregarCategoria();">
                    ...
                    <div class="p-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="catNombre" name="catNombre"
                                aria-describedby="nombreHelp" required placeholder="Ingrese el nombre de la categoría">
                        </div>
                        <button type="submit" id="btnCategoria" class="btn btn-outline-info btn-lg">Agregar</button>
                    </div>
                </div>
            </form>
        </div>

...
if (isset($_POST['nombre_user']) && isset($_POST['contrasena_user'])) {
    ...
    if ($usuario->isUsuario($usarioForm, $passwordForm)) {
        ...
        $err = "Tus credenciales están incorrectas";
    }
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <img src="img/Imagen de Inicio.png" style="width: 200px; height: 200px;">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="nombre_user" placeholder="Correo electrónico"
                            required>
                    </div>
                    <!-- Campo de entrada para la contraseña -->
                    <div class="form-group">
                        <input type="password" class="form-control" name="contrasena_user" placeholder="Contraseña"
                            required>
                    </div>
